// Taken from https://github.com/michaeltaranto/less-vars-to-js/blob/master/src/index.js
// Duplicated here because the .babelrc in `less-vars-to-js` conflicts with our own.
